...
namespace LKaifer_Blog.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            if (returnUrl != null)
            {
                if (returnUrl.Contains("Comments/Create"))
                {
                    string cSlug = TempData["currentSlug"] as string;
                    returnUrl = Url.Action("Details", "BlogPosts", new { slug = cSlug });
                }
            }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //How do I recreate the sending of an email??
                    ...
                    //Step 2: I need an instance of Personal Email
                    var svc = new PersonalEmail();

                    //Step 3:  I fire off the appropriate method of the PersonalEmail class
