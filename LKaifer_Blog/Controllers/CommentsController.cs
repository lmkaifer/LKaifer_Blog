...
namespace LKaifer_Blog.Controllers
{
    ...
    public class CommentsController : Controller
    {
        ...
        {               
            if (ModelState.IsValid)
            {
                comment.BlogPost = db.BlogPosts.FirstOrDefault(b => b.Id.Equals(comment.BlogPostId));
        ...
        {
            Comment comment = db.Comments.Find(id);
            BlogPost post = db.BlogPosts.FirstOrDefault(b => b.Id.Equals(comment.BlogPostId));
